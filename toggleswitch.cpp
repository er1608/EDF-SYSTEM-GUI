    ...
    , _enabled(true)
{
    ...
    _offcolor = QColor(240, 248, 255);
    _oncolor = QColor(25, 25, 112);
    _tol = 0;
    _borderradius = 12;
...
void MainWindow::addToggleSwitch()
{
    SwitchButton* togsw = new SwitchButton(this);

    togsw->move(10, this->height() - 110);

    connect(this, &MainWindow::resized, this, [this, togsw]() {
        togsw->move(10, this->height() - 110);
    });

    connect(togsw, &SwitchButton::valueChanged, _homeTab, [this]() {
        swcurrent = !swcurrent;
    });
}
